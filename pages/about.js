    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.textBox}>
          ...
          <p>joShare is a micro file sharing platform. Now what do I mean by micro file sharing?? <br /><br />By micro file sharing I mean that you can share small size (below 30 Mega Bytes) files with anyone. Files like pdf, docs, pptx, cvs, jpg, jpeg, png etc can be shared with others. How does joShare works?? <Link href="/howtouse">Read This</Link></p>
        </div>
